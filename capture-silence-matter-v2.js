...
const FRAMES_DIR = '/tmp/silence-v2-frames';
const OUT_FILE   = path.join(__dirname, 'silence-of-matter-v2.mp4');
const HTML_FILE  = 'file://' + path.join(__dirname, 'silence-of-matter-v2.html');
const DURATION   = 45500;
...
(async () => {
  ...
  console.log('Loading silence-of-matter-v2.html...');
