...
const FRAMES_DIR = '/tmp/cmos-demo-frames';
const OUT_FILE   = path.join(__dirname, 'cmos-v5-demo.mp4');
const HTML_FILE  = 'file://' + path.join(__dirname, 'cmos-v5-demo.html');
const DURATION   = 25500;    // 25.5s
...
(async () => {
  ...
  while (Date.now() - start < DURATION) {
    ...
    await page.screenshot({ path: filename, type: 'jpeg', quality: 94 });
    frame++;
