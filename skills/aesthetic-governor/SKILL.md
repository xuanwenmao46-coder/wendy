...
- For specific color science, LUT references, and palette construction: `COLOR-DIRECTOR.md` *(to be created)*
- For photographic treatment, lens character, and image grading: `PHOTOGRAPHY-DIRECTOR.md` *(to be created)*
- For the full school recipe library: [`aesthetic-layout-direction/STYLE-SCHOOL-MAP.md`](../aesthetic-layout-direction/STYLE-SCHOOL-MAP.md) and `VIDEO-RECIPES.md` *(to be created in this skill directory)*
